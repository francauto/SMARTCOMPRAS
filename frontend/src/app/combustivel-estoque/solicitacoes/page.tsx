...
export default function SolicitacoesCombustivelEstoquePage() {
  ...
  const reloadData = () => {
    ...
    combustivelEstoqueService
      .listarPorSolicitante(page, pageSize, filtros)
      .then((resultado) => {
      ...
      .catch(() => {
        setError("Erro ao carregar suas solicitações de combustível estoque.");
      })
        ...
        <div className="w-full max-w-[95vw] xl:max-w-[1600px] flex flex-col min-h-0">
          ...
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-2xl font-bold text-black">
              Suas Solicitações de Combustível - Estoque
            </h1>
            <button
          ...
          <Table
            ...
            emptyMessage="Nenhuma solicitação de combustível estoque encontrada."
            getRowId={(row) => row.id}
            enableRowHover={true}
            onRowClick={(row) => {
